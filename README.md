...
![](media/ControlTowerIntegration.png)
...
If you are new to AWS, see [Getting Started with AWS](https://aws.amazon.com/getting-started/) . For additional information about AWS Marketplace, see [AWS Marketplace Overview](https://aws.amazon.com/mp/marketplace-service/overview/).
...
![Graphical user interface, text, application, email Description automatically generated](media/Picture2.png)

 **Renewal Settings**. 1 year option (to add when publish listing)
...
![Graphical user interface, text, application, email Description automatically generated](media/Picture3.png)
...
![Graphical user interface, text, application, email Description automatically generated](media/Picture11.png)
...
![Graphical user interface, application Description automatically generated](media/Picture12.png)
5.  Click **Next**.

6.  Optionally, enter the Tags for your CloudFormation stack and / or click Next.

![Graphical user interface, application Description automatically generated](media/Picture13.png)

7.  Acknowledge creating IAM resources and click **Create stack**.

![Graphical user interface, text, application Description automatically generated](media/Picture14.png)
...
![Graphical user interface, text, application, email Description automatically generated](media/Picture15.png)
...
![Graphical user interface, application, Teams Description automatically generated](media/Picture19.png)
...
![Graphical user interface, application, Teams Description automatically generated](media/Picture20.png)
...
![Graphical user interface, text, application, email Description automatically generated](media/Picture21.png)
What to expect
...
![Graphical user interface, application Description automatically generated](media/Picture22.png)
...
![Graphical user interface, text, application, email Description automatically generated](media/Picture23.png)
...
![Graphical user interface, application, website Description automatically generated](media/Picture24.png)
...
![Graphical user interface, text, application Description automatically generated](media/Picture25.png)
